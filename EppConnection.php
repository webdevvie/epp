...
use Webdevvie\Epp\Simple\SimpleEppMessage;
...
class EppConnection extends AbstractConnection
{
     ...
     * @var boolean
     */
    protected $mimickServerGreeting = false;
     ...
     * @throws ConnectionException
     */
    public function write(EppMessage $eppMessage)
    {
     ...
     * @return null|EppMessage|SimpleEppResponse
     * @throws ConnectionException
     */
